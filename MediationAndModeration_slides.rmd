...
# this is just to show that centering variables around the mean doesn't
# change the variance.
...
# In order to create a plot looking at different slopes, this creates a new
# variable with three different categories.
...
```{r}
model1 <- lmres(Aggression ~ Vid_Games + CaUnTs + Vid_Games*CaUnTs,
